    ...
    <div class="container px-6 py-16 mx-auto">
        <div class="items-center lg:flex py-20 sm:py-8">
            ...
            <div class="flex items-center justify-center w-full mt-6 lg:mt-0 lg:w-1/2">
                <img class="w-full h-full lg:max-w-2xl drop-shadow-xl" src="<?php echo e(asset('img/CrownLogoOnly.svg')); ?>"
...
<?php /**PATH C:\xampp\htdocs\crown\resources\views/livewire/guest/components/hero.blade.php ENDPATH**/ ?>
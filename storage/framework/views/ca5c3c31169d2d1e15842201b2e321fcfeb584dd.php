<?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('guest.components.hero')->html();
} elseif ($_instance->childHasBeenRendered('l3924067051-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l3924067051-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3924067051-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3924067051-0');
} else {
    $response = \Livewire\Livewire::mount('guest.components.hero');
    $html = $response->html();
    $_instance->logRenderedChild('l3924067051-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<section class="py-5 bg-indigo-200 dark:bg-indigo-900">
    <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('guest.components.newsletter')->html();
} elseif ($_instance->childHasBeenRendered('l3924067051-1')) {
    $componentId = $_instance->getRenderedChildComponentId('l3924067051-1');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3924067051-1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3924067051-1');
} else {
    $response = \Livewire\Livewire::mount('guest.components.newsletter');
    $html = $response->html();
    $_instance->logRenderedChild('l3924067051-1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH C:\xampp\htdocs\crown\resources\views/livewire/guest/pages/home.blade.php ENDPATH**/ ?>
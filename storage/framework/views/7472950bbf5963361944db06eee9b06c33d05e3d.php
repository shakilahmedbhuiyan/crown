            ...
            <div class="lg:col-span-3">
                ...
                <div class="flex items-center justify-between">
                    ...
                    <p class="text-sm text-gray-500">
                        ...
                        <span>Page <?php echo e($currentPage); ?> of <?php echo e(ceil(count($data) / $perPage)); ?></span>
                ...
                <div
                    ...
                    <?php if($data): ?>
                        <?php $__currentLoopData = array_slice($data, ($currentPage - 1) * $perPage, $perPage); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
} elseif ($_instance->childHasBeenRendered('l1268013926-2')) {
    $componentId = $_instance->getRenderedChildComponentId('l1268013926-2');
    $componentTag = $_instance->getRenderedChildComponentTagName('l1268013926-2');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l1268013926-2');
} else {
    $response = \Livewire\Livewire::mount('guest.components.cart-button', ['item' => $item['id']]);
    $html = $response->html();
    $_instance->logRenderedChild('l1268013926-2', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                    </div>
                ...
                <div class="mx-2 text-sm font-sans bg-transparent flex justify-evenly font-bold text-red-500">
                    ...
                    <button wire:click="$set('currentPage', $currentPage - 1)"
                            <?php echo e($currentPage == 1 ? 'disabled' : ''); ?>>Previous</button>

                    <button wire:click="$set('currentPage', $currentPage + 1)"
                            <?php echo e($currentPage == ceil(count($data) / $perPage) ? 'disabled' : ''); ?>>Next</button>

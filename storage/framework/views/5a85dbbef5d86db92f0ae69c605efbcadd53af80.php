...
<?php if (! $__env->hasRenderedOnce('88bf2855-d6e2-4c43-9f21-3a816ff3b1eb')): $__env->markAsRenderedOnce('88bf2855-d6e2-4c43-9f21-3a816ff3b1eb'); ?>
...
<?php $component->withAttributes(['wire:model' => 'confirmingPassword']); ?>
         ...
         <?php $__env->slot('content', null, ['class' => 'dark:bg-gray-800']); ?> 
...
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['type' => 'password','class' => 'mt-1 block w-3/4','placeholder' => ''.e(__('Password')).'','x-ref' => 'confirmable_password','wire:model.defer' => 'confirmablePassword','wire:keydown.enter' => 'confirmPassword']); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['for' => 'confirmable_password','class' => 'mt-2']); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\crown\resources\views/components/confirm-password.blade.php ENDPATH**/ ?>